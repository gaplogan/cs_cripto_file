...
namespace CriptoFile
{
    class Criptografia
    {
        ...
        {
            bool result = true;
            // Salve a chave pública criada pelo RSA para um arquivo.
            // Cuidado, persistindo no chave para um arquivo é um risco de segurança.
            if (rsa == null)
            {
                return false;
            }
        ...
        {
            // Criar uma instância de Aes para
            ...
            // rsa é instanciado anteriormente:
            //    rsa = new RSACryptoServiceProvider(cspp);
            ...
            // Altere a extensão do arquivo para ".enc"
            ...
            try
            {
                using (FileStream outFs = new FileStream(outFile, FileMode.Create))
                {
                    ...
                    // Agora escreva o texto cifrado usando
                    // um CryptoStream para criptografar.
                    using (CryptoStream outStreamEncrypted = new CryptoStream(outFs, transform, CryptoStreamMode.Write))
                    {
                        // Ao criptografar um pedaço em
                        // uma vez, você pode economizar memória
                        // e acomodar arquivos grandes.
                        int count = 0;
                        int offset = 0;
        ...
        {
            // Criar instância de Aes para
            // descriptografia simétrica dos dados.
            Aes aes = Aes.Create();
            ...
            try
            {
                ...
                // (inFs)e salve o arquivo descriptografado(outFs).
                using (FileStream inFs = new FileStream(EncrFolder + inFile, FileMode.Open))
                {
                    ...
                    // Determine a posição inicial do texto 
                    // cifrado(startC) e seu comprimento(lenS).
